  ...
  return (
    <div>
      ...
      <Stack>
        ...
        <Box fontSize="12px">
          <Text color={colorMode === "light" ? "#3b3b3b" : "#c9c9c9"}>
            {EmployMockData[currentIndex].title}
          </Text>
          <Text
            color={colorMode === "light" ? "#3b3b3b" : "#c9c9c9"}
            fontSize="14px"
            fontWeight="600"
            noOfLines={1}
          >
          ...
          <HStack justifyContent="space-between" alignItems="flex-end">
            ...
            <HStack justifyContent="flex-end">
              <HStack spacing="0" pr="1" fontSize="14px">
                <Box color={colorMode === "light" ? "#3b3b3b" : "#c9c9c9"}>
                  {currentIndex + 1}
                </Box>
